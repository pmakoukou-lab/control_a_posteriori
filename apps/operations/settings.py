...
# email settings — MailHog (serveur SMTP de développement)
# Lancer MailHog puis ouvrir http://localhost:8025 pour voir les e-mails captés.
# SMTP sur localhost:1025, sans authentification ni TLS/SSL.
SMTP_SSL = False
SMTP_SERVER = 'localhost:1025'
SMTP_SENDER = 'noreply@monapp.ci'
SMTP_LOGIN = None
SMTP_TLS = False

# Réinitialisation de mot de passe (controllers/password_reset.py) :
# False = envoie réellement via le SMTP ci-dessus (MailHog) ;
# True  = n'envoie pas, journalise seulement le lien dans la console.
RESET_DEBUG = False
# SMTP_SSL = False
# SMTP_SERVER = None
...
SESSION_SECRET_KEY = "KkWl7BgKX-yZL8nvqovzb3bsl_HJacmSxEbLXI4_Eo8"  # or replace with your own secret
...
# ── Expiration des tokens (en secondes) ──
TOKEN_EXPIRY_VERIFY_EMAIL   = 86400   # 24 heures
TOKEN_EXPIRY_RESET_PASSWORD = 3600    # 1 heure